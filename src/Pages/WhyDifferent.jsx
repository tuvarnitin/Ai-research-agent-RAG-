  ...
  return (
      <section className="w-full flex flex-col md:px-20 sm:pt-50 py-10 sm:flex-row bg-background">
          ...
          <div className="w-full md:w-1/2 flex justify-center flex-col px-8 sm:px-20 space-y-1">
              <h1 className="text-[max(2.2vw,22px)] font-bold tracking-wider font-[sansation-bold]">WHY THIS SYSTEM IS DIFFERENT</h1>
              <ul className="space-y-1 list-disc">
                  <li className="text-[max(1.1vw,16px)] leading-5 font-[sansation-light]">
                      OAnswers are grounded in documents, not guesses.
                  </li>
                  <li className="text-[max(1.1vw,16px)] leading-5 font-[sansation-light]">
                      Full transparency through source-based responses.
                  </li>
                  <li className="text-[max(1.1vw,16px)] leading-5 font-[sansation-light]">
                      Designed for private and sensitive data.
                  </li>
                  <li className="text-[max(1.1vw,16px)] leading-5 font-[sansation-light]">
